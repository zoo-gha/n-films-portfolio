...
export default function Testimonials() {
    return (
        <section className="font-mont text-black">

            <div className="text-center py-8">

                <h5 className="cursor-pointer"> Testimonials </h5>
                <h1 className="text-2xl w-96 mx-auto leading-normal font-bold mb-12">Read What Others Have to Say</h1>

                <div className="max-w-5xl mx-auto grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-8 group">
