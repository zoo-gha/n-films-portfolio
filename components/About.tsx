    ...
    return (
        <section className="container mx-auto py-10 px-4 font-mont">
            <div className="px-8">
                ...
                <p className="py-2 px-4 text-slate-600">This is some information about us</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px]">
                ...
                <div className="flex justify-center items-center">
                    <div className="before:content-[''] before:absolute before:bg-[conic-gradient(#04b0ee_20deg,transparent_120deg)] before:w-[400px] before:h-[500px] before:top-[-15%] before:left-[-25%] before:animate-fullSpin relative w-[270px] h-[400px] bg-emerald-900 rounded-xl overflow-hidden">
                        <img className="w-[260px] h-[390px] before:left-[25%] drop-shadow-2xl rounded-lg  object-cover " src="/pic.jfif" alt="us" />
                    </div>
